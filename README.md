...
> Coming from v0.5.x? Point `littleimp migrate` at your v0.5 `data/` directory (`db.sqlite` + `user-uploads/`), or at a `.zip`/`.tar.gz` of that folder. See the [migration API reference](./API.md#migrate).
