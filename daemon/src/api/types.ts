...
export type CaptureSourceDto = ApiDto<"CaptureSource">;
export type BookmarkCaptureMetadataDto = ApiDto<"BookmarkCaptureMetadata">;
export type CaptureRequestDto = ApiDto<"CaptureRequest">;
export type CaptureResultDto = ApiDto<"CaptureResult">;
export type CaptureResponseDto = ApiDto<"CaptureResponse">;
