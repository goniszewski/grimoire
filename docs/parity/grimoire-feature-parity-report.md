...
| Tags | Tag CRUD and bookmark assignment | Tag API list/create/delete/attach/detach; UI assign/remove/filter, dedicated management page, and tag detail pages | Partial | Tag management is in review through TASK-098, tag detail pages are complete through TASK-099, and tag rename remains the approved gap for TASK-100. |
