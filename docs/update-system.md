...
This document describes the update behavior shipped for the `1.1.0`
...
| `LITTLEIMP_VERSION` | One-command installer | Select the release version to download. Defaults to `1.1.0`. |
...
These ideas are not shipped in `1.1.0`:
